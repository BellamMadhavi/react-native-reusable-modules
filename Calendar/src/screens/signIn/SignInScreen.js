...
import {ScrollView, Text,View, Image,TextInput, StyleSheet, Alert, Dimensions, Button} from 'react-native';
  ...
  return(
    <View style={{flex:1.5}}>
      ...
      <View style={{
        ...
        borderBottom:1,
        marginBottom: 10,}}>
          <TextInput style={styles.input} placeholder='Email' placeholderTextColor='#ccc' value={credentials.email} onChangeText={(text)=>setCredentials({...credentials,email: text.trim()})} />
